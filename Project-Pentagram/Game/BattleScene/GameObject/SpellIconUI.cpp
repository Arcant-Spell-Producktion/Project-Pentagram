...
void SpellIconUI::SetIconType(IconType type)
{
    m_Type = type;
    UpdateIcon();
}
...
void SpellIconUI::UpdateIcon()
{
    ...
    m_IconBorder->SetSpriteByIndex(SpellDetail->SpellOwner == CasterPosition::CasterA ? 0 : 1 , (int)m_Type);
    SetTransparency((int)m_Type % 2 || m_isPreview);
}
